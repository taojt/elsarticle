...
%\begin{split}
%d_{\alpha}(\tilde{A}, \tilde{B}) = \max \lbrace &sup_{a \in \tilde{A}} inf_{b \in \tilde{B}} \norm{a-b}, \\
%&sup_{b \in \tilde{B}} inf_{a \in \tilde{A}} \norm{a-b} \rbrace
%\end{split}
%\end{equation}
...
%\caption{abc}\label{fig:2}
%\end{figurehere}



 %a modified Hausdorff distance between fuzzy sets defined as this: Let $\tilde{A_{\alpha}}$ and $\tilde{B_{\alpha}}$  be the $\alpha - cut$ of them respectively. Under the $\alpha - cut$ of $\tilde{A_{\alpha}}$ and $\tilde{B_{\alpha}}$ the Hausdorff distance be denoted by $d _{\alpha}(A,B)$
